<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<form id="insertAddressForm" onsubmit="return false;">
	<div class="form-box address-info"
		style="width: 885px; float: left; padding-top: 0px; padding-left: 15px;">

		<div class="sub-tit " style="margin: 0px;">
			<a class="add" href="javascript:history.go(-1);"><i
				class="iconfont icon-reply"></i>返回</a>
			<ul>
				<li class="selected"><a href="javascript:;">添加地址</a></li>
			</ul>
		</div>
		...
		<dl class="form-group">
			...
			<dd>
				<input name="userId" type="hidden"
					value="${sessionScope.vipuser.id }"> <input name="userName"
					type="text" class="input Validform_error"
					value="${sessionScope.vipuser.username }" readonly="readonly">
			</dd>
		</dl>
		<dl class="form-group">
			<dt>所属地区：</dt>
		...
		<dl class="form-group">
			<dt>手机号码：</dt>
			<dd>
				<input name="phone" type="text" class="input" datatype="m"
					sucmsg=" ">
			</dd>
		</dl>
		<dl class="form-group">
		...
		<dl class="form-group">
			<dt></dt>
			<dd>
				<input type="button" value="添加" onclick="insertAddress()"
